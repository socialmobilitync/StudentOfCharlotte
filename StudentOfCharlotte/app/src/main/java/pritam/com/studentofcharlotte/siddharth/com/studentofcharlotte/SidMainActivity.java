...
import pritam.com.studentofcharlotte.*;
...
public class SidMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView nameUpdate = (ImageView) findViewById(R.id.profile_img_update_name);
        //Log.d("Error!!!","Name = "+prof_class.getText());
        final DatabaseReference dbRef= FirebaseDatabase.getInstance().getReference();
        dbRef.child("students").child(LoginActivity.uId).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                interests=(ListView)findViewById(R.id.listView);
                adapter=new InterestAdapter(SidMainActivity.this,R.layout.interest_list, MainActivity.studentInterestList);
        ...
        nameUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(SidMainActivity.this,UpdateActivity.class);
        ...
        findViewById(R.id.interestEdit).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String[] groups = getResources().getStringArray(R.array.intrestList);
                final ArrayList<String> hobbies= new ArrayList<String>();
                for (String hobby : groups){
                    hobbies.add(hobby);
                }
                /*hobbies.add("Study");
                ...
                AlertDialog.Builder builder=new AlertDialog.Builder(SidMainActivity.this);
                builder.setTitle("Join your Group")
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        for(int i=0;i<hobbyChoice.size();i++) {
                            ...
                            intObj.setiPoint("5");
                            intObj.setiRank("1");
                            dbRef.child("students").child(LoginActivity.uId).child("interest").child("interest_" +idCode).setValue(intObj);
                            dbRef.child("students").child(LoginActivity.uId).child("interest").child("interest_" +idCode).child("iAchievement").child("A1").setValue(achObj);
            ...
            if (requestCode == 100 || requestCode ==200) {
                ...
                dbRef.child("students").child(LoginActivity.uId).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        interests=(ListView)findViewById(R.id.listView);
                        InterestAdapter adapter=new InterestAdapter(SidMainActivity.this,R.layout.interest_list,interestList);
